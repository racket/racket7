...
scheme_init_port_fun(Scheme_Startup_Env *env)
{
  ...
  ADD_NONCM_PRIM("read-char-or-special",           read_char_spec,                 0, 3, env);
  ADD_NONCM_PRIM("read-byte",                      read_byte,                      0, 1, env);
  ADD_NONCM_PRIM("read-byte-or-special",           read_byte_spec,                 0, 3, env);
  ...
  ADD_NONCM_PRIM("peek-char-or-special",           peek_char_spec,                 0, 4, env);
  ADD_NONCM_PRIM("peek-byte",                      peek_byte,                      0, 2, env);
  ADD_NONCM_PRIM("peek-byte-or-special",           peek_byte_spec,                 0, 5, env);
