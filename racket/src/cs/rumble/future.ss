...
(define halt-workers (lambda () (void)))
(define resume-workers (lambda () (void)))
(define future-wait (lambda () (void)))

(define (set-future-callbacks! _future? _current-future _block wait cfp hw rw)
  (set! future? _future?)
